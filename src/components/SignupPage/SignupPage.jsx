            ...
            <div className="flex items-center gap-3 mt-2">
              <div className="relative flex items-center">
                <input
                  ...
                  className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border border-gray-600 bg-gray-50 transition-all checked:border-orange-500 checked:bg-orange-500 focus:ring-2 focus:ring-orange-500/50 focus:ring-offset-0"
                />
