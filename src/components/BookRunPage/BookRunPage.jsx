...
const NextRunDetails = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center text-orange-500 font-mono text-sm uppercase tracking-[0.2em]">
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center text-red-500 font-mono text-sm uppercase tracking-[0.2em]">
        <span>{error}</span>
      </div>
    );
  }
    ...
    <div className="relative min-h-screen bg-black text-white py-24 md:py-32 overflow-hidden font-sans selection:bg-orange-500 selection:text-black">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="mb-12 max-w-8xl justify-center mx-auto">
          {isLoggedIn ? (
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 md:p-6 bg-[#050505] border border-orange-500/30 rounded-2xl shadow-[0_0_20px_rgba(249,115,22,0.1)]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 p-5 md:p-6 bg-[#030303] border border-white/10 rounded-2xl">
              <div className="flex items-center gap-4">
