...
export const heroStyles = {
  ...
  ctaCard: "relative rounded-2xl p-6 bg-[rgba(255,255,255,0.04)] border border-black/6 backdrop-blur-md shadow-2xl flex items-center justify-between gap-4",
  subtitle: "text-xs uppercase tracking-widest text-sky-300/70",
  title: "text-black md:text-sm text-lg sm:text-2xl font-semibold mt-1",
...
export const loginStyles = {
  pageContainer: "min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-500 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 sm:px-6 md:px-8 text-black",
  ...
  backButton: "absolute top-3 left-6 z-10 flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-3 rounded-full transition-shadow duration-300 shadow-lg hover:shadow-xl bg-black/5 text-black hover:bg-black/10",
  ...
  form: {
    ...
    input: "w-full pl-10 pr-3 py-3 sm:py-4 rounded-xl text-sm sm:text-base placeholder-opacity-70 border transition duration-300 focus:outline-none focus:ring-2 focus:border-transparent bg-black/5 backdrop-blur-sm text-black/90 placeholder-orange-200/40 border-black/10 focus:ring-orange-500/70",
  ...
  signupSection: "mt-6 pt-6 border-t border-black/10 text-center text-xs sm:text-sm",
  signupText: "text-orange-200/70",
  signupButton: "inline-block mt-2 w-full cursor-pointer px-4 py-2 rounded-xl font-medium transition-transform duration-300 transform hover:-translate-y-0.5 bg-transparent border border-orange-500/50 text-orange-300/90 hover:bg-orange-500/10 hover:text-black/90"
};


// assets/dummyStyles.js
export const signupStyles = {
  pageContainer: "min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-500 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-black",
  ...
  backButton: "absolute top-4 sm:top-6 left-4 sm:left-6 z-10 flex items-center gap-1 sm:gap-2 px-3 py-2 sm:px-4 sm:py-3 rounded-full transition-all duration-300 group shadow-lg hover:shadow-xl bg-black/5 text-black hover:bg-black/10",
  ...
  form: {
    ...
    inputWrapper: "relative",
    inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-orange-300/80",
    input: "w-full pl-10 pr-3 py-2 sm:py-3 md:py-4 rounded-xl text-xs sm:text-sm placeholder-opacity-70 border focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 bg-black/5 backdrop-blur-sm text-black/90 placeholder-orange-200/40 border-black/10 focus:ring-orange-500/70",
    passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer transition-colors text-orange-300/80 hover:text-orange-200/90",
  ...
  signinButton: "inline-block w-full px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-xl font-medium transition-all duration-300 transform hover:-translate-y-0.5 text-xs sm:text-sm md:text-base bg-transparent border border-orange-500/50 text-orange-300/90 hover:bg-orange-500/10 hover:text-black/90"
};
...
export const homeCarsStyles = {
  container: "relative w-full overflow-hidden py-16 bg-white text-gray-900 min-h-screen",
  ...
  priceBadge: "absolute top-40 md:top-50 lg:top-50 right-4 z-20 bg-gray-50/80 backdrop-blur-md text-black px-3 py-1.5 rounded-full font-bold text-sm shadow-lg flex items-center",
  ...
  placeholder: "bg-white border-2 border-gray-700 border-dashed rounded-xl w-full h-full flex items-center justify-center text-sky-500",
  cardPatterns: [
...
export const carDetailStyles = {
  ...
  specValue: "font-semibold text-base sm:text-lg text-black",
  aboutSection: "bg-gray-800/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-gray-700 space-y-3",
  aboutTitle: "text-xl sm:text-2xl font-semibold text-black",
  aboutText: "text-gray-700 text-sm sm:text-base",
  ...
  bookingTitle: "text-2xl sm:text-2xl font-bold text-black",
  bookingSubtitle: "text-gray-400 text-sm",
  form: "space-y-4",
  grid2: "grid grid-cols-2 gap-3",
  formLabel: "text-xs sm:text-sm text-gray-700 mb-1",
  ...
  inputField: "w-full pl-10 pr-2 py-1.5 sm:py-2 bg-transparent text-gray-800 text-sm sm:text-base outline-none",
  textInputField: "w-full pl-10 pr-3 py-1.5 sm:py-2 bg-transparent text-gray-800 text-sm sm:text-base outline-none",
  priceBreakdown: "bg-gray-700/40 p-3 rounded-lg text-sm space-y-1 border border-gray-600",
  priceRow: "flex justify-between text-gray-700",
  totalRow: "border-t border-gray-600 pt-1 flex justify-between font-semibold text-black",
  submitButton: "w-full flex items-center justify-center py-2.5 rounded-lg bg-gradient-to-r from-orange-400 to-orange-500 cursor-pointer text-black font-bold hover:from-orange-400 hover:to-orange-500 transition-all group"
};
...
export const testimonialStyles = {
  ...
  star: "mr-1",
  comment: "text-gray-700 italic text-lg mb-8",
  ...
  avatar: "bg-gradient-to-br from-orange-500 to-orange-700 w-14 h-14 rounded-full flex items-center justify-center text-black font-bold text-xl",
  authorInfo: "ml-4",
  authorName: "font-bold text-black text-lg",
  ...
  ctaTitle: "text-3xl font-bold text-black font-[pacifico] mb-4",
  ctaText: "text-gray-400 max-w-2xl mx-auto font-[pacifico] mb-8",
  ctaButton: "bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-500 hover:to-orange-600 text-black font-bold py-3 font-[pacifico] px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-orange-500/20",
...
export const footerStyles = {
  container: "relative bg-white text-black pt-16 sm:pt-20 md:pt-24 overflow-hidden border-t border-black/10",
  ...
  socialIcon: "w-8 h-8 sm:w-10 sm:h-10 bg-black/5 border border-black/10 hover:bg-orange-400 transition-colors rounded-full flex items-center justify-center text-sm sm:text-base",
  ...
  input: "w-full bg-black/5 border border-black/10 rounded-lg py-2 px-3 sm:py-3 sm:px-4 focus:outline-none focus:ring-2 focus:ring-cyan-500 text-black text-sm sm:text-base",
  subscribeButton: "w-full flex items-center justify-center py-2 sm:py-3 bg-orange-400 hover:from-cyan-600 hover:to-blue-700 cursor-pointer text-black font-medium rounded-lg transition-transform duration-300 transform hover:-translate-y-1 text-sm sm:text-base",
  copyright: "border-t border-black/10 mt-10 sm:mt-12 pb-4 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm sm:text-base",
...
export const contactPageStyles = {
  ...
  subtitle: "text-base sm:text-lg md:text-xl text-gray-700 max-w-xl mx-auto",
  ...
  infoLabel: "font-medium text-gray-700 text-sm sm:text-base",
  ...
  offerTitle: "text-gray-700 font-medium text-sm sm:text-base",
  ...
  input: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-700/50 text-black rounded-lg border ${
    isActive ? 'border-orange-500' : 'border-gray-600'
  } focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm transition-all`,
  select: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-700/50 cursor-pointer text-black rounded-lg border ${
    isActive ? 'border-orange-500' : 'border-gray-600'
  ...
  textarea: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-700/50 text-black rounded-lg border ${
    isActive ? 'border-orange-500' : 'border-gray-600'
  } focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm transition-all`,
  submitButton: "w-full cursor-pointer flex items-center justify-center py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 rounded-lg text-black font-medium text-sm shadow-md transition-all transform hover:-translate-y-0.5 group mt-2",
...
export const carPageStyles = {
  ...
  priceBadge: "absolute bottom-3 left-3 bg-orange-400 text-black px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium shadow-lg",
  cardContent: "p-4 sm:p-5 md:p-6",
  headerRow: "flex justify-between items-center mb-4",
  carName: "text-lg sm:text-xl font-bold text-black",
...
export const myBookingsStyles = {
  // Page container
  pageContainer: "min-h-screen bg-gradient-to-b pt-40 from-gray-900 to-black text-black py-12 px-4 sm:px-6 lg:px-8",
  ...
  filterButton: (isActive, type) => {
    ...
    if (!isActive) return `${base} bg-gray-800 text-gray-700 hover:bg-gray-700`;
    
    switch(type) {
      case "all": return `${base} bg-orange-600 text-black`;
      case "upcoming": return `${base} bg-blue-600 text-black`;
      case "completed": return `${base} bg-green-600 text-black`;
      case "cancelled": return `${base} bg-red-600 text-black`;
      default: return base;
    }
  },
  ...
  retryButton: "mt-4 px-4 py-2 bg-orange-600 rounded-lg text-black",
  ...
  browseButton: "inline-block mt-6 px-6 py-3 bg-gradient-to-r from-orange-600 to-orange-700 text-black rounded-lg flex items-center justify-center gap-2",
  ...
  // Modal
  modalOverlay: "fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4",
  ...
  cancelButton: "px-3 py-2 bg-red-600 hover:bg-red-700 rounded-md text-black mr-2",
  modalContent: "p-6",
